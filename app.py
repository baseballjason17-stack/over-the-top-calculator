...
if page == "🏠 Home & Patch Notes":
    ...
    if guide_step == "🎃 Weight Calculator (OTT)":
        ...
        **How to use it:** 1. Enter your 5-digit ZIP code in the sidebar.  2. Enter your current Days After Pollination (DAP).  3. Check the daily risk cards to see if overnight temps are dipping too low or if high humidity is creating a mildew risk.
        """)
    elif guide_step == "📅 16-Day Weather Outlook":
        st.write("""
        **What it does:** Provides a long-term look at wind trends, temperatures, and moisture.
        
        **How to use it:** 1. Enter your 5-digit ZIP code in the side bar.  2. View the daily weather cards to see future weather conditions
        """)
        ...
        **How to use it:** 1. Enter your 5-digit ZIP code.  2. Enter the pollination date reference.  3. Use the evaluation window slider to pick how many days you wish to view.
